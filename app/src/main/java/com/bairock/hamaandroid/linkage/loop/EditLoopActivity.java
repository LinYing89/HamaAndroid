...
import com.bairock.hamaandroid.adapter.RecyclerAdapterCondition;
import com.bairock.hamaandroid.adapter.RecyclerAdapterEffect;
...
import com.bairock.hamaandroid.database.LinkageConditionDao;
import com.bairock.hamaandroid.database.LinkageDao;
import com.bairock.hamaandroid.linkage.ConditionActivity;
import com.bairock.hamaandroid.linkage.LinkageBaseFragment;
import com.bairock.hamaandroid.linkage.timing.EditTimingActivity;
...
public class EditLoopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zLoop = (ZLoop) LinkageBaseFragment.LINKAGE;
        if (zLoop == null) {
            finish();
            return;
        }
