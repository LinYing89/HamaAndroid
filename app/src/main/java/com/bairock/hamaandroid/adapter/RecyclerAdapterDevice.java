...
public class RecyclerAdapterDevice extends RecyclerView.Adapter<RecyclerAdapterDevice.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ViewHolder vh = new ViewHolder(mInflater.inflate(R.layout.search_device_list, parent, false));
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void refreshState() {
            if (device.isNormal()) {
                redGreen.setBackgroundResource(R.drawable.normal_green);
            } else {
                redGreen.setBackgroundResource(R.drawable.abnormal_red);
            }
        }
